"""
Django settings for tus_demo project.
...
SECRET_KEY = 'django-insecure-u+bvazt9!^%%j#(c*g-(@n(j@b!iub_d_+z)^i4=0n9kor+83q'
...
WSGI_APPLICATION = 'tus_demo.wsgi.application'
